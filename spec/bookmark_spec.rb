...
describe Bookmark do
    ...
    describe ".all" do
        ...
        it "returns a hard coded list of bookmarks" do
            bookmark = Bookmark.create(name: "Google", href: "https://www.google.com", comment_class: comment_class)
            Bookmark.create(name: "YouTube", href: "https://www.youtube.com", comment_class: comment_class)
            Bookmark.create(name: "Github", href: "https://www.github.com", comment_class: comment_class)

            bookmarks = Bookmark.all(comment_class: comment_class)
    ...
    describe ".create" do
        ...
        it "does not create a new bookmark if the URL is not valid" do
            Bookmark.create(name: 'not a real bookmark', href: 'not a real bookmark', comment_class: comment_class)
            expect(Bookmark.all(comment_class: comment_class)).to be_empty
        end
    ...
    describe ".delete" do
        ...
        it "deletes the bookmark" do
            bookmark = Bookmark.create(name: "test", href: "https://www.testurl.com", comment_class: comment_class)
            expect(Bookmark.all(comment_class: comment_class).length).to eq(1)
            expect{ Bookmark.delete(id: bookmark.id) }.to change{ Bookmark.all(comment_class: comment_class).length }.from(1).to(0)
        end
    ...
    describe ".find" do
        ...
        it "finds a and returns a bookmark object from its id" do
            bookmark = Bookmark.create(name: "test", href: "https://www.testurl.com", comment_class: comment_class)
            returned_bookmark = Bookmark.find(id: bookmark.id, comment_class: comment_class)
    ...
    describe ".update" do
        ...
        it "updates the name and href of a bookmark" do
            bookmark = Bookmark.create(name: "test", href: "https://www.testurl.com", comment_class: comment_class)
            updated_bookmark = Bookmark.update(id: bookmark.id, name: "updated_test", url: "https://www.updatedtesturl.com", comment_class: comment_class)
        ...
        it "does not update a bookmark if the URL is not valid" do
            bookmark = Bookmark.create(name: "test", href: "https://www.testurl.com", comment_class: comment_class)
            expect(Bookmark.update(id: bookmark.id, name: "updated_test", url: "invalid url", comment_class: comment_class)).to be(false)
        end
    ...
    describe "#intialize" do
        ...
        it "is initialized with an id, name and href link" do
            subject = described_class.new(id: 1, name: "Google", href: "https://www.google.com", comment_class: comment_class)
            expect(subject.id).to eq(1)
            expect(subject.name).to eq("Google")
            expect(subject.href).to eq("https://www.google.com")
            expect(subject.comment_class).to eq(comment_class)
        end
    ...
    describe "#add_comment" do
        ...
        it "calls Comment.create with the the bookmark.id and text for the comment" do
            bookmark = described_class.new(id: 1, name: "Google", href: "https://www.google.com", comment_class: comment_class)
            expect(comment_class).to receive(:create).with(text: "this is a comment", bookmark_id: bookmark.id)
            bookmark.add_comment(text: "this is a comment")
        end
